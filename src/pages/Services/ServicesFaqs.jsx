  ...
  return (
    <div className="border-b border-black  py-5">
      ...
      >
        ...
        <svg
          className={`w-5 h-5 text-gray-600 cursor-pointer transform transition-transform duration-200 ${
...
const ServicesFaqs = () => {
  ...
  return (
    <div className="py-16 px-4 md:px-8 lg:px-16 bg-gray-100 relative overflow-hidden w-full mx-auto">
      {/* Decorative Shape Top Right */}
      <div className="absolute top-0 right-0 w-30 h-30 md:w-40 md:h-40 bg-green-400 rounded-bl-full -mt-10 -mr-10 opacity-80 z-0"></div>
      ...
      <div className="max-w-3xl mx-auto text-center mb-12 relative z-10">
        ...
        <p>
          Find answers to your most pressing questions about our payment and
          delivery services.
        </p>
      </div>
