...
const offerings = [
  {
    ...
    description:
      "Choose from various payment methods, including UPI, cards, and wallets.",
  },
  {
    image: pricingImage,
...
const ServicesOfferings = () => {
  return (
    <div className="py-16 px-4 md:px-8 lg:px-16 bg-gray-50 relative overflow-hidden max-w-[1500px]mx-auto  ">
      {/* Decorative Shape Top Right */}

      <div className="absolute top-0 right-0 w-30 h-30 md:w-40 md:h-40 bg-[#1F3C5F] rounded-bl-full -mt-10 -mr-10 opacity-80"></div>
      ...
      <div className="text-center mb-12 max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-gray-600 max-w-5xl mx-auto mb-6">
          We provide a range of services tailored to meet your needs. From
          seamless payment integration to efficient delivery scheduling, we've
          got you covered.
        </p>
      </div>
      ...
      <div className="text-center relative z-10 flex justify-center items-center space-x-4">
        <button className="px-6 py-2 border border-green-500 text-black rounded hover:bg-green-50 transition duration-300">
          Learn More
        </button>
        <a
          href="#"
          className="text-black hover:text-blue-700 font-medium flex items-center"
        >
          Sign Up
          <svg
      ...
      <div className="absolute bottom-0 left-0 w-30 h-30 md:w-40 md:h-40 bg-green-400 rounded-tr-full -mb-10 -ml-10 opacity-80"></div>
      {/* <div className="absolute bottom-0 left-0 w-60 h-60 md:w-[260px] md:h-[260px] opacity-80 -mb-10 -ml-10">
        <div className="relative w-full h-full rounded-full bg-green-400"></div>
