...
const offerImage = 'https://s3-alpha-sig.figma.com/img/e184/1a83/7820b173d6418b19ff2cb3ad6d56574b?Expires=1745798400&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=A4LcNW0Ay-pUrcLm--wqfG2U8LLPnuJ601vC~kqQ0Wd~l7fjvHAPbt7hrOuEfo1kxjui~-UxcqBZ5BCeW-LFA1WhYg312Pg6a1Y9J1C7NuDaiXCbtzwO4oe4UO3ZVLlNF74vkIuBH8nIJsjos7wQn~gbv4D15IoRfzhDVvuCJ2wKJVFaKGuUmCGKngmYpLCBjTId-67Q5hkknUHYlqljBKn6ZytAtei8Z1mt9hKIID1ni01PszDO~PNcBuL0K-uOM6-ZfePsQBCC-ZTm1pPBmXZ~8P660Yen9LWna4ac5Dtfdv-RtwQSTvg4VIFMkvPAwFTs2vUxcFlgT92RVxT47Q__';

const ServicesExclusiveOffer = () => {
  return (
    // Changed background to white, added vertical padding
    <div className="bg-white text-black flex flex-col md:flex-row items-center py-12 md:py-20">
      {/* Left Side - Text and Form */}
      {/* Adjusted padding */}
      <div className="md:w-1/2 px-8 md:px-12 lg:pl-14 lg:pr-14 flex flex-col justify-center mb-8 md:mb-0">
        ...
        <p className="text-gray-600 mb-6">
          Sign up today to unlock special discounts and streamline your payment experience with us.
        </p>
        {/* Form container */}
        <div className="flex flex-col sm:flex-row items-stretch w-full max-w-lg mb-4">
          ...
          <button className="bg-[#1F3C5F] hover:bg-blue-800 text-white font-semibold py-3 px-6 rounded transition duration-300 whitespace-nowrap shadow-md">
            Sign Up
          </button>
        </div>
