...
//       <div className="w-[50%] flex flex-col items-left p-[5%] gap-3">
//         <h1 className="text-4xl font-bold text-[#1F3C5F]">Get in Touch</h1>
//         <p className="mt-2">We are here to assist you with any inquiries.</p>
...
//               name="firstName"
//               id="firstName"
//               className="border-2 border-black rounded-lg p-2 focus:outline-none focus:border-[#1F3C5F]"
//             />
//           </div>
//           <div className="flex flex-col w-full md:w-1/2">
...
//           </div>
//           <div className="flex flex-col w-full md:w-1/2">
//             <label htmlFor="phoneNumber" className="mb-2 text-black">
//               Phone Number
//             </label>
//             <input
//               type="tel"
...
//             name="topic"
//             id="topic"
//             className="border-2 border-black rounded-lg p-2 w-full md:w-3/4 focus:outline-none focus:border-[#1F3C5F]"
//           >
...
const ContactForm = () => {
  return (
    <div className="flex flex-col lg:flex-row p-4 md:p-6 bg-[#F5F7EB]">
      {/* Contact Info Section */}
      <div className="w-full lg:w-1/2 flex flex-col px-4 py-6 sm:px-6 gap-3">
        <h1 className="text-3xl md:text-4xl font-bold text-[#1F3C5F]">
          Get in Touch
        </h1>
        ...
        <p className="flex items-center text-gray-800">
          <FaMapMarkerAlt className="mr-2 text-[#1F3C5F]" />
          123 Sample St, Sydney NSW 2000 AU
        </p>
      </div>

      {/* Contact Form Section */}
      <div className="w-full lg:w-1/2 px-4 py-6 sm:px-6">
        <ContactFormComponent />
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6">
          <div className="flex flex-col w-full md:w-1/2">
            <label htmlFor="firstName" className="mb-2 text-black font-medium">
              First Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col w-full md:w-1/2">
            <label htmlFor="lastName" className="mb-2 text-black font-medium">
              Last Name
            </label>
            <input
              type="text"
        ...
        {/* Topic Selector */}
        <div className="flex flex-col">
          <label htmlFor="topic" className="mb-2 text-black font-medium">
            Select a topic
          </label>
          <select
            name="topic"
        ...
        <div className="flex flex-col space-y-2">
          ...
          <textarea
            ...
            rows="4"
            placeholder="Write your message ..."
            className="border-2 border-gray-300 rounded-lg p-2 w-full resize-y min-h-[100px] focus:outline-none focus:border-[#1F3C5F]"
          ></textarea>
        </div>
        ...
        <button
          type="submit"
          className="bg-[#1F3C5F] text-white px-6 py-2 rounded-lg hover:bg-[#2a507a] transition-colors w-full md:w-auto hover:cursor-pointer"
        >
          Submit
        </button>
      </form>
